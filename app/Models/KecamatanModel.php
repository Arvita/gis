...
class KecamatanModel extends Model
{
    ...
    {
        return DB::table('kecamatan')->insert($data);
    }
    ...
    {
        return DB::table('kecamatan')->where('id_kecamatan', $id_kecamatan)->update($data);
    }

    public function DeleteData($id_kecamatan)
    {
        return DB::table('kecamatan')->where('id_kecamatan', $id_kecamatan)->delete();
    }
}
