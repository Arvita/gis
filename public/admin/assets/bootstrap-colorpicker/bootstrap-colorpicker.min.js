                    ...
                    [
                        {
                            ...
                            value: function api(fn) {
                                ...
                                var result = this._color[fn].apply(
                                    this._color,
                                    args
                                );
                        ...
                        },
                        {
                            ...
                            value: function generate(formula) {
                                ...
                                if (Array.isArray(formula)) {
                                    ...
                                    !ColorItem.colorFormulas.hasOwnProperty(
                                        formula
                                    )
                                ) {
                                    throw new Error(
            ...
            var Palette = (function (_Extension) {
                ...
                function Palette(colorpicker) {
                    ...
                    var _this = _possibleConstructorReturn(
                        this,
                        (
                            Palette.__proto__ || Object.getPrototypeOf(Palette)
                        ).call(
                            this,
                            colorpicker,
                ...
                _createClass(Colorpicker, [
                    ...
                    },
                    {
                        ...
                        value: function getValue() {
                            ...
                            val =
                                val instanceof _ColorItem2.default
                                    ? val
                                    : defaultValue;
            ...
            var Debugger = (function (_Extension) {
                ...
                function Debugger(colorpicker) {
                    ...
                    var _this = _possibleConstructorReturn(
                        ...
                        (
                            Debugger.__proto__ ||
                            Object.getPrototypeOf(Debugger)
                        ).call(this, colorpicker, options)
                    );
            ...
            var Swatches = (function (_Palette) {
                ...
                function Swatches(colorpicker) {
                    ...
                    var _this = _possibleConstructorReturn(
                        ...
                        (
                            Swatches.__proto__ ||
                            Object.getPrototypeOf(Swatches)
                        ).call(
                            this,
                            colorpicker,
                            _jquery2.default.extend(true, {}, defaults, options)
                ...
                _createClass(Swatches, [
                    ...
                    },
                    {
                        ...
                        value: function onCreate(event) {
                            ...
                            this.element = (0, _jquery2.default)(
        ...
        function (module, exports, __webpack_require__) {
            ...
            var SliderHandler = (function () {
                function SliderHandler(colorpicker) {
                    ...
                    this.onMove = _jquery2.default.proxy(
                        this.defaultOnMove,
                        this
                    );
                }
                        ...
                        value: function pressed(e) {
                            ...
                            for (var sliderName in sliders) {
                                ...
                                if (zone.is(slider.selector)) {
                                    this.currentSlider =
                                        _jquery2.default.extend({}, slider, {
                                            name: sliderName,
                                        });
                                    break;
                                } else if (
                ...
                _createClass(InputHandler, [
                    ...
                    },
                    {
                        ...
                        value: function getFormattedColor() {
                            ...
                            if (
                                this.colorpicker.options.useHashPrefix === false
                            ) {
                                val = val.replace(/^#/g, "");
                            }
                            return val;
        ...
        function (module, exports, __webpack_require__) {
            ...
            function Color(obj, model) {
                ...
                if (obj == null) {
                    ...
                    this.valpha =
                        typeof obj[channels] === "number" ? obj[channels] : 1;
                    ...
                    if ("alpha" in obj) {
                        ...
                        this.valpha =
                            typeof obj.alpha === "number" ? obj.alpha : 0;
                    }
            ...
            Object.keys(convert).forEach(function (model) {
                ...
                Color.prototype[model] = function () {
                    ...
                    var newAlpha =
                        typeof arguments[channels] === "number"
                            ? channels
                            : this.valpha;
                    return new Color(
                        assertArray(
                            convert[this.model][model].raw(this.color)
                        ).concat(newAlpha),
                        model
                    );
                };
                ...
                _createClass(ColorHandler, [
                        ...
                        value: function createColor(val) {
                            ...
                            var autoHexInputFallback =
                                ...
                                arguments[2] !== undefined
                                    ...
                                    : false;
                            var disableHexInputFallback =
                                !fallbackOnInvalid && !autoHexInputFallback;
                    ...
                    },
                    {
                        ...
                        value: function getFallbackColor() {
                            ...
                            var fallback = this.resolveColorDelegate(
                                this.fallback
                            );
                            var color = new _ColorItem2.default(
                                fallback,
