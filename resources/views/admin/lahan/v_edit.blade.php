                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row form-group">
                            <div class="col-lg-4">
                                ...
                                <input class="form-control" id="luas_panen" name="luas_panen" type="text" placeholder="Masukkan Luas Panen"  value="{{ $lahan->luas_panen }}"/>
                                <small class="text-danger" role="alert">
                                    @error('luas_panen')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-lg-4">
                                ...
                                <input class="form-control" id="produksi" name="produksi" type="text" placeholder="Masukkan Luas Produksi" value="{{ $lahan->produksi }}" />
                                <small class="text-danger" role="alert">
                                    @error('produksi')
                                        {{ $message }}
                                    @enderror
