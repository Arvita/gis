...
<main>
    ...
    <div class="container mt-n10">
        ...
        <form method="POST" action="/kecamatan/insert">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input class="form-control" id="namaKecamatan" name="namaKecamatan" type="text" placeholder="Nama Kecamatan" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="geojson" name="geojson" type="text" rows="4" placeholder="Geo JSON"></textarea>
